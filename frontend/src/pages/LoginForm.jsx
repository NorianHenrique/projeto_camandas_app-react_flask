...
const LoginForm = () => {
    ...
    const onSubmit = (data) => {
        const { usuario, senha } = data; // Corrija para correspondência dos nomes dos campos
        login(usuario, senha);
    };
    ...
    return (
        <Box component="form" onSubmit={handleSubmit(onSubmit)}
            ...
            <Card elevation={8} sx={{ maxWidth: 450, width: '100%', borderRadius: 4, overflow: 'hidden', alignItems: 'center' }}>
                <Box sx={{ background: 'linear-gradient(90deg, #6A11CB 0%, #2575FC 100%)', padding: 3, textAlign: 'center' }}>
                    <Typography variant="h4" color="white" fontWeight="bold" sx={{ textShadow: '1px 1px 2px rgba(0,0,0,0.2)' }}>
                        Bem-vindo
                    </Typography>
